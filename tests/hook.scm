...
(define test-runner-default
  (@@ (test-runners) test-runner-run64))
...
(test-begin "sendemail-validate")
(setenv "GUIX_STACK_TEST" "1")

(test-assert "fails-when-not-last-patch"
