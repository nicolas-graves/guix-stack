     ...
     (origin
       ...
       (patches
        (list
         ...
         (origin
           (method url-fetch)
           (uri "https://lists.sr.ht/~ngraves/devel/%3C20250115014712.23859-1-ngraves@ngraves.fr%3E/raw")
           (sha256 (base32 "1nlml59wzxr8wn5yyaflv6mnysl16q3d4kiih9vvdwkw0l2hb8jk")))))))))
